...
try {
  await Notification.create({
    ...
    title: "New Brand Deal! 🏷️",
    // We use user.name which will show "Rawaha" or the Brand Name
    description: `${user.name} just posted a new deal: ${offer.title}!`,
    type: "Offers",
    icon: "megaphone",
    link: offer._id.toString()
  });
} catch (nError) {
